...
from data_loader import get_hybrid_dpo_dataset
...
def main(args):
    ...
    train_dataset = get_hybrid_dpo_dataset(args.chosen_data_file, args.rejected_data_file, args.num_pairs)    
...
if __name__ == "__main__":
    ...
    class ScriptArguments:
        ...
        model_name: Optional[str] = field(default="/mnt/2050data/xiaoxuan/llms/deepseek-math-7b-rl", metadata={"help": "the policy model name"})
        ref_model_name: Optional[str] = field(default="/mnt/2050data/xiaoxuan/llms/deepseek-math-7b-rl", metadata={"help": "the reference model name"})
        chosen_data_file: Optional[str] = field(default="/mnt/2050data/xiaoxuan/sft-code/samples/qwen2.5-math-7b-instruct-orig-math-total-sample-0.json", metadata={"help": "the model name"})
        rejected_data_file: Optional[str] = field(default="/mnt/2050data/xiaoxuan/sft-code/samples/deepseek-math-7b-rl-orig-math-total-sample-0.json", metadata={"help": "the model name"})
        num_pairs: Optional[int] = field(default=15, metadata={"help": "number of DPO-data pairs for each prompt"})
        output_dir: Optional[str] = field(default="./checkpoints/deepseek-math-7b-rl-math-hybrid-rpo-checkpoint-1-15pair", metadata={"help": "directory"})


        # model_name: Optional[str] = field(default="/mnt/2050data/xiaoxuan/llms/Qwen2.5-Math-7B-Instruct", metadata={"help": "the policy model name"})
        # ref_model_name: Optional[str] = field(default="/mnt/2050data/xiaoxuan/llms/Qwen2.5-Math-7B-Instruct", metadata={"help": "the reference model name"})
        # chosen_data_file: Optional[str] = field(default="/mnt/2050data/xiaoxuan/sft-code/samples/llama3.1-8b-instruct-qwen-prompt-gsm8k-total-sample-0.json", metadata={"help": "the model name"})
        # rejected_data_file: Optional[str] = field(default="/mnt/2050data/xiaoxuan/sft-code/samples/qwen2.5-math-7b-instruct-orig-gsm8k-total-sample-0.json", metadata={"help": "the model name"})
        # num_pairs: Optional[int] = field(default=15, metadata={"help": "number of DPO-data pairs for each prompt"})
        # output_dir: Optional[str] = field(default="./checkpoints/qwen2.5-7b-instruct-gsm8k-hybrid-rpo-checkpoint-1-15pair", metadata={"help": "directory"})
        ...
        # beta: Optional[float] = field(default=0.4, metadata={"help": "beta"})
